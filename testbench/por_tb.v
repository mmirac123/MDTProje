...
module por_tb;
    ...
    wire [15:0] led; wire [6:0] seg; wire [3:0] an; wire dp, RsTx;
    integer hata = 0;

    always #5 clk = ~clk;                       // 100 MHz

    top #(.MS_DIV(100), .CLKS_PER_BIT(10)) dut (
    ...
    initial begin
        ...
        kontrol(dut.aktif === 4'b0011,
                "aktif = oyuncu_maske & yasayan = 0011");
        ...
        //  SEQ animasyonu suruyor olmali (silahli = 1), tur ANINDA bitmemeli
        kontrol(dut.silahli === 1'b1, "tur basladi, silahli = 1");
